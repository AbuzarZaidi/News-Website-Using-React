  ...
  const topHeadline = [
    {
      ...
      description:
        "After a year of subtle and not so subtle disrespect, UFC president Dana White wasn’t even willing to put the belt on Francis Ngannou after he beat Ciryl Gane.",
      ...
      content:
        "UFC 270 ended with an interesting fight between heavyweight champion Francis Ngannou and interim champion Ciryl Gane. After all the drama surrounding the two former teammates and Ngannous issues with… [+4650 chars]",
    },
    {
      author: null,
      title:
        "Italy's Berlusconi hospitalised in Milan since Thursday - source - Reuters",
      description:
      ...
      content:
        "MILAN, Jan 23 (Reuters) - Former Italian Prime Minister Silvio Berlusconi has been in Milan's San Raffaele hospital since Thursday, a person with knowledge of the matter said on Sunday after the 85-y… [+1296 chars]",
    },
  ];
  return (
    <>
